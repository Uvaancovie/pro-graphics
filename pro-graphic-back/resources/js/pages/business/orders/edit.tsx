...
export default function EditOrder({ order, clients }: Props) {
        ...
        <>
            ...
            <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <Heading title="Edit Order" description={`Editing order "${order.order_number}"`} />
                </div>
...
EditOrder.layout = {
    breadcrumbs: [
        ...
        { title: 'Edit', href: '/business/orders/{id}/edit' },
    ],
};
