...
export default function CreateDesign({ projects, teamMembers }: Props) {
        ...
        <>
            ...
            <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <Heading title="Create Design" description="Upload a new design asset" />
                </div>
...
CreateDesign.layout = {
    breadcrumbs: [
        ...
        { title: 'Create', href: '/business/designs/create' },
    ],
};
