            ...
            <Card className="shadow-2xl border-2 border-black/10">
                <CardHeader className="bg-black text-white p-8">
                    ...
                    <CardDescription className="text-gray-200 text-lg">
                        Fill out the form below and we'll provide a detailed quote within 24 hours
                    </CardDescription>
                </CardHeader>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. 082 123 4567 or 031 508 6700"
                                    />
                                    {errors.phone && (
                        ...
                        {selectedService && (
                            <div className="p-6 bg-gray-50 rounded-xl border-2 border-gray-200">
                                ...
                                {selectedService === "custom-stickers" && (
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm font-bold text-black mb-2">Quantity</label>
                                            <input {...register("stickerQuantity", { valueAsNumber: true })} type="number" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-black font-medium" placeholder="500" />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-bold text-black mb-2">Size</label>
                                            <input {...register("stickerSize")} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-black font-medium" placeholder="100mm x 100mm" />
                                        </div>
                                    </div>
                                )}
                            </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-bold text-black mb-2">Budget Range</label>
                                        <select {...register("budget")} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg text-black font-medium bg-white">
                                    ...
                                    <div>
                                        ...
                                        <select {...register("timeline")} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg text-black font-medium bg-white">
