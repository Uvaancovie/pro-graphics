...
import { Button } from "@/components/ui/Button"; // Let's assume you have a generic Button or use standard classes
...
export default function CanvasProductConfigurator({ product }: ProductProps) {
  ...
  const handleInquiry = () => {
    // You can redirect to the quote page with preed parameters or call an API route here
