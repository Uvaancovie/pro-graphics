...
export default function CostCalculator() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow-xl">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center md:text-3xl lg:text-4xl">
        Cost Calculator
      </h2>
      ...
      {!category ? (
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button 
            ...
            className="w-full sm:w-auto md:w-[180px] text-base sm:text-lg py-4 sm:py-6 px-4 sm:px-8"
          >
            Canvas Pricing
          </Button>
          <Button 
        ...
        <div className="space-y-6">
          <button 
            ...
            className="text-blue-600 hover:text-blue-800 font-medium mb-4 flex items-center text-sm sm:text-base"
          >
          ...
          {category === "CANVAS" && (
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <h3 className="text-xl font-semibold text-gray-700 border-b pb-2 sm:text-2xl">
                Canvas Calculator
              </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {(Object.keys(canvasPricing) as CanvasSize[]).map((size) => (
                    ...
                    >
                      ...
                      <div className="text-blue-600 font-medium sm:text-base">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full p-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-0 transition-colors text-sm sm:text-base"
                />
              </div>

              <div className="mt-6 p-6 bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl text-white text-center shadow-lg">
                <div className="text-sm font-medium text-blue-100 mb-2 sm:text-base">
                  Total Estimated Cost
                </div>
                <div className="text-3xl font-bold text-white sm:text-4xl">
                  R{calculateCanvasCost().toFixed(2)}
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {(["330ML", "500ML"] as WaterVolume[]).map((vol) => (
                    ...
                    >
                      ...
                      <div className="text-orange-600 font-medium sm:text-base">
                        R1.00 each
                      </div>
                      <div className="text-xs text-gray-500 mt-1 sm:text-sm">
                        R0.85 + VAT
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full p-3 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:ring-0 transition-colors text-sm sm:text-base"
                />
              </div>

              <div className="mt-6 p-6 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl text-white text-center shadow-lg">
                <div className="text-sm font-medium text-orange-100 mb-2 sm:text-base">
                  Total Estimated Cost
                </div>
                <div className="text-3xl font-bold text-white sm:text-4xl">
                  R{calculateWaterCost().toFixed(2)}
                </div>
              </div>
            </div>
          )}
