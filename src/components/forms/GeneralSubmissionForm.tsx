    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/general-submission`,
                {
                    method: "POST",
                    headers: {
        ...
        return (
            <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center shadow-lg">
                ...
                <p className="text-gray-700 max-w-2xl mx-auto">
                    ...
                    If your message is security- or privacy-related, it will be handled with .
                </p>
            </div>
        );
    }
            ...
            <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    {[
                        ...
                        { icon: <AlertTriangle className="w-5 h-5" />, title: "Security matters", text: "Security and privacy concerns are handled with ." },
