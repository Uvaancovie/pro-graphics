        ...
        <main className="min-h-screen">
            ...
            <section className="py-20 bg-gray-50 border-t border-gray-200">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        ...
                        <Link to="/blog/essential-guide-custom-sign-boards" className="text-blue-900 font-semibold hover:text-amber-600 transition-colors">
                            Sign Boards Guide
                        </Link>
                    </div>
                </div>
            ...
            <section className="py-16 bg-gray-50 border-t border-gray-200">
                <div className="container mx-auto px-4 max-w-5xl text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        <Link to="/vehicle-branding/umhlanga" className="text-blue-900 font-semibold hover:text-amber-600 transition-colors">
                            Vehicle Branding Umhlanga
                        </Link>
                        <Link to="/vehicle-branding/pinetown" className="text-blue-900 font-semibold hover:text-amber-600 transition-colors">
                            Vehicle Branding Pinetown
                        </Link>
                        <Link to="/vehicle-branding/phoenix" className="text-blue-900 font-semibold hover:text-amber-600 transition-colors">
                            Vehicle Branding Phoenix
                        </Link>
                        <Link to="/vehicle-branding/durban-cbd" className="text-blue-900 font-semibold hover:text-amber-600 transition-colors">
